...
#creating a series(kind of row in a datasets-->a=[series])

a = [12,10,8,14]
series = pandas.Series(a)
print(series)
print(series[1]) # returns index value of 1
print(series[1:3]) # returns value in range

a1 = [12,10,8,14]
series1 = pandas.Series(data = a, index = [1,2,3,4])
print(series1)
